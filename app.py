...
with open('data/list_of_symptoms2.pickle', 'rb') as data_file:
    symptoms_list = pickle.load(data_file)

with open('models/fitted_model_v2.pickle', 'rb') as modelFile:
...
def index():
    data = []
    user_symptoms.clear()
    files = open("static/assets/files/ds_symptoms.txt", "r")
    all_symptoms = files.readlines()
